...
export default function Header() {
    ...
    return (
        <header>
            ...
            <nav>
                {isAuthenticated && (<span style={{ fontFamily: 'Arial, sans-serif', fontSize: '16px', fontWeight: 'bold', color: '#333', backgroundColor: '#f0f0f0', padding: '5px 10px', borderRadius: '5px', marginBottom: '3px' }}>Hello, {(email.slice(0, email.indexOf('@'))) || username}!</span>)}
